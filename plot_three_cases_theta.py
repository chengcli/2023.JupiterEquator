...
# adiabatic
data = Dataset('outputs/juno_mwr-ad-166-main.nc', 'r')
...
# super-adiabatic
data = Dataset('outputs/juno_mwr-ad-169-main.nc', 'r')
tb = data['radiance'][0,:,0,0]
tb45 = tb[3::4]
...
# sub-adiabatic
data = Dataset('outputs/juno_mwr-ad-163-main.nc', 'r')
tb = data['radiance'][0,:,0,0]
tb45 = tb[3::4]
...
ax.plot(temp_ad, pres, 'k-', label='$\\Theta_{1bar} = 166 K$')
ax.plot(temp_sup, pres, 'C0-', label='$\\Theta_{1bar} = 169 K$')
ax.plot(temp_sub, pres, 'C1-', label='$\\Theta_{1bar} = 163 K$')
...
#show()
savefig('three_cases_theta.png', bbox_inches='tight')
