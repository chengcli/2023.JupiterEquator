...
# adiabatic
data = Dataset('outputs/juno_mwr-rh0.5-main.nc', 'r')
...
# super-adiabatic
data = Dataset('outputs/juno_mwr-rh1.0-main.nc', 'r')
tb = data['radiance'][0,:,0,0]
tb45 = tb[3::4]
...
# sub-adiabatic
data = Dataset('outputs/juno_mwr-rh0.1-main.nc', 'r')
tb = data['radiance'][0,:,0,0]
tb45 = tb[3::4]
...
ax.plot(nh3_ad, pres, 'k-', label='RH = 0.5')
ax.plot(nh3_sup, pres, 'C0-', label='RH = 1.0')
ax.plot(nh3_sub, pres, 'C1-', label='RH = 0.1')
...
#show()
savefig('three_cases_rh.png', bbox_inches='tight')
